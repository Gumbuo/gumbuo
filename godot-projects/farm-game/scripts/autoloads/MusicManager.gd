...
const MUSIC_TRACKS := [
	...
	{"name": "Easy Breeze",     "file": "res://assets/audio/music/playstarz_music-chill-background-music-485206.mp3"},
	{"name": "Mellow Fields",   "file": "res://assets/audio/music/aussomamama-chill-music-for-games-206325.mp3"},
]

var track_index: int = 2  # Mellow Fields plays on first launch
