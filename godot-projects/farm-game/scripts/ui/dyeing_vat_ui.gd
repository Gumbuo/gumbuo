...
const STATION_TITLE  := "DYEING VAT"
const BORDER_COLOR   := Color(0.55, 0.10, 0.55)
const TITLE_COLOR    := Color(0.95, 0.50, 0.95)
const ACTION_LABEL   := "DYE"

# Recipes will be filled in here. x10 needs purple_potion, x100 needs red_potion.
const RECIPES: Dictionary = {
	"cotton_thread_blue":   {"desc": "Blue-dyed cotton thread.",   "ing": {"cotton_thread": 1, "blue_flower": 18},                                       "energy": 3},
	"cotton_thread_red":    {"desc": "Red-dyed cotton thread.",    "ing": {"cotton_thread": 1, "red_flower": 18},                                        "energy": 3},
	"cotton_thread_yellow": {"desc": "Yellow-dyed cotton thread.", "ing": {"cotton_thread": 1, "yellow_flower": 18},                                     "energy": 3},
	"cotton_thread_green":  {"desc": "Green-dyed cotton thread.",  "ing": {"cotton_thread": 1, "blue_flower": 9, "yellow_flower": 9},                    "energy": 3},
	"cotton_thread_orange": {"desc": "Orange-dyed cotton thread.", "ing": {"cotton_thread": 1, "red_flower": 9, "yellow_flower": 9},                     "energy": 3},
	"cotton_thread_brown":  {"desc": "Brown-dyed cotton thread.",  "ing": {"cotton_thread": 1, "red_flower": 6, "blue_flower": 6, "yellow_flower": 6},   "energy": 3},
}

const RES_NAME:  Dictionary = {
	"cotton_thread": "Cotton Thread",
	"blue_flower": "Blue Flower", "red_flower": "Red Flower", "yellow_flower": "Yellow Flower",
}
const RES_COLOR: Dictionary = {
	"cotton_thread": Color(0.90, 0.90, 0.85),
	"blue_flower":   Color(0.30, 0.50, 0.90),
	"red_flower":    Color(0.85, 0.20, 0.20),
	"yellow_flower": Color(0.90, 0.80, 0.10),
}
const ITEM_COLOR:Dictionary = {
	"cotton_thread_blue":   Color(0.30, 0.50, 0.90),
	"cotton_thread_red":    Color(0.85, 0.20, 0.20),
	"cotton_thread_yellow": Color(0.90, 0.80, 0.10),
	"cotton_thread_green":  Color(0.25, 0.72, 0.35),
	"cotton_thread_orange": Color(0.90, 0.50, 0.10),
	"cotton_thread_brown":  Color(0.52, 0.32, 0.18),
}
