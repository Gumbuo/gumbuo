...
export default function AlienLeaderboard() {
  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-6 bg-gradient-to-br from-black via-gray-900 to-black bg-opacity-95 border-2 border-green-400 rounded-xl w-96 relative overflow-hidden shadow-2xl shadow-green-400/50">
      ...
      <h2 className="text-4xl font-bold bg-gradient-to-r from-green-400 via-green-300 to-green-400 bg-clip-text text-transparent tracking-wider flex items-center justify-center space-x-2 drop-shadow-lg relative z-10">
