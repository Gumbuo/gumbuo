...
onready var title_label = $color_rect/v_box_container/TitleLabel
onready var message_label = $color_rect/v_box_container/MessageLabel
...
func _ready():
	...
	# Style the title with cyan/green color like main menu
	if title_label:
		title_label.add_color_override("font_color", Color(0, 1, 0.690196, 1))

	# Style the message label
	if message_label:
		message_label.add_color_override("font_color", Color(1, 1, 1, 1))

	# Apply simple color styling to buttons
	if restart_button:
		restart_button.add_color_override("font_color", Color(1, 1, 1, 1))
		restart_button.add_color_override("font_color_hover", Color(0, 1, 0.690196, 1))
		restart_button.add_color_override("font_color_pressed", Color(0, 1, 0.690196, 1))

	if main_menu_button:
		main_menu_button.add_color_override("font_color", Color(1, 1, 1, 1))
		main_menu_button.add_color_override("font_color_hover", Color(0, 1, 0.690196, 1))
		main_menu_button.add_color_override("font_color_pressed", Color(0, 1, 0.690196, 1))
