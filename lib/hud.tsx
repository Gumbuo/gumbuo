...
export function AlienHUD() {
  ...
  if (!isConnected) {
    return (
      <div className="holographic-panel glass-panel p-6 rounded-xl shadow-2xl max-w-md relative">
  ...
  return (
    <div className="holographic-panel glass-panel p-6 rounded-xl shadow-2xl max-w-md relative">
      ...
      <div className="relative z-10">
        <h2 className="text-lg mb-3 flex items-center space-x-2 font-electro">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="space-y-2">
            <p className="text-xs text-gray-500 uppercase tracking-wider">💎 ETH Holdings:</p>
