...
export const ITEMS: Record<string, ArmoryItem> = {
  ...
  'plasma-pistol': {
    ...
    type: 'weapon',
    tier: 1,
    icon: '/images/armory/weapons/plasma-pistol.png',
    sellValue: 100,
    stats: { attack: 15 },
  },
  'bio-blade': {
    ...
    type: 'weapon',
    tier: 1,
    icon: '/images/armory/weapons/bio-blade.png',
    sellValue: 80,
  ...
  'plasma-shield': {
    ...
    type: 'armor',
    tier: 1,
    icon: '/images/armory/armor/plasma-shield.png',
    sellValue: 120,
    stats: { defense: 10 },
  },
  'bio-vest': {
    ...
    type: 'armor',
    tier: 1,
    icon: '/images/armory/armor/bio-vest.png',
    sellValue: 150,
  ...
  'void-rifle': {
    ...
    type: 'weapon',
    tier: 2,
    icon: '/images/armory/weapons/void-rifle.png',
    sellValue: 250,
  ...
  'quantum-dagger': {
    ...
    type: 'weapon',
    tier: 2,
    icon: '/images/armory/weapons/quantum-dagger.png',
    sellValue: 200,
  ...
  'void-helm': {
    ...
    type: 'armor',
    tier: 2,
    icon: '/images/armory/armor/void-helm.png',
    sellValue: 300,
  ...
  'plasma-cannon': {
    ...
    type: 'weapon',
    tier: 3,
    icon: '/images/armory/weapons/plasma-cannon.png',
    sellValue: 500,
  ...
  'nebula-blade': {
    ...
    type: 'weapon',
    tier: 3,
    icon: '/images/armory/weapons/nebula-blade.png',
    sellValue: 750,
  ...
  'quantum-armor': {
    ...
    type: 'armor',
    tier: 3,
    icon: '/images/armory/armor/quantum-armor.png',
    sellValue: 800,
  ...
  'void-annihilator': {
    ...
    type: 'weapon',
    tier: 4,
    icon: '/images/armory/weapons/void-annihilator.png',
    sellValue: 1500,
  ...
  'nebula-exosuit': {
    ...
    type: 'armor',
    tier: 4,
    icon: '/images/armory/armor/nebula-exosuit.png',
    sellValue: 2000,
