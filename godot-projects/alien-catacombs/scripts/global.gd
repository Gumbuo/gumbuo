...
const INPUT_ACTIONS:Array = ["move_up","move_down","move_left","move_right","attack_punch","attack_kick","shoot","weapon_1","weapon_2","weapon_3","ui_inventory","ui_codex","menu","menu_special"]
