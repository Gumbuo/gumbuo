...
const STATION_TITLE  := "SPINNING WHEEL"
const BORDER_COLOR   := Color(0.45, 0.35, 0.55)
const TITLE_COLOR    := Color(0.85, 0.75, 1.00)
const ACTION_LABEL   := "SPIN"

# Recipes will be filled in here. x10 needs purple_potion, x100 needs red_potion.
const RECIPES: Dictionary = {
	"cotton_thread": {"desc": "Spun cotton thread. Used in dyeing and crafting.", "ing": {"cotton": 9}, "energy": 3},
}

const RES_NAME:  Dictionary = {"cotton": "Cotton"}
const RES_COLOR: Dictionary = {"cotton": Color(0.95, 0.95, 0.90)}
const ITEM_COLOR:Dictionary = {"cotton_thread": Color(0.90, 0.90, 0.85)}
