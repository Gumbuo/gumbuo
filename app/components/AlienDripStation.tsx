...
export default function AlienDripStation() {
  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-6 bg-gradient-to-br from-black via-purple-900/30 to-black bg-opacity-95 border-2 border-purple-500 rounded-xl w-80 relative overflow-hidden shadow-2xl shadow-purple-500/50">
