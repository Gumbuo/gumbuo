  ...
  return (
    <div className="flex flex-col items-center space-y-6 w-full max-w-7xl mx-auto">
      ...
      {isOnAbstract && !isCorrectNetwork && (
        <div className="w-full p-6 bg-yellow-900/30 border border-yellow-500 rounded-3xl text-center">
          ...
          <div className="flex flex-col gap-3 items-center">
            <button
              ...
              className="px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-3xl transition-all"
            >
              ➕ Add Abstract Testnet to MetaMask
            </button>
            <button
              onClick={handleSwitchNetwork}
              className="px-6 py-3 bg-red-600 hover:bg-red-500 text-white font-bold rounded-3xl transition-all"
            >
      ...
      {/* Mint Section */}
      <div style={{borderRadius: '8px'}} className="w-full holographic-panel glass-panel p-8">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mb-6">
            {ALIEN_TYPES.map((alienType) => (
              <button
                ...
                className={`p-2 rounded-3xl border-2 transition-all ${
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {selectedNFTTokenId !== null && (
            <div className="mb-4 p-3 bg-cyan-900/30 border border-cyan-500/50 rounded-3xl text-center">
          ...
          {hasQueuedFighter && queuedFighter ? (
            <div className={`bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-3xl p-6 border-4 ${
            ...
            <div className={`bg-black/40 rounded-3xl p-8 border-4 border-dashed ${
